...
const germanWords = {
    ...
    // 💼 ROZMOWA O PRACĘ (A2-B1)
    job_interview: [
        { german: "die Bewerbung", polish: "aplikacja / podanie o pracę", example: "Ich schicke meine Bewerbung per E-Mail.", level: "A2" },
        { german: "sich bewerben um", polish: "ubiegać się o (pracę)", example: "Ich bewerbe mich um diese Stelle.", level: "A2" },
        { german: "der Lebenslauf", polish: "CV / życiorys", example: "Mein Lebenslauf ist aktuell.", level: "A2" },
        { german: "das Vorstellungsgespräch", polish: "rozmowa kwalifikacyjna", example: "Morgen habe ich ein Vorstellungsgespräch.", level: "B1" },
        { german: "die Stelle", polish: "stanowisko / posada", example: "Die Stelle ist noch frei.", level: "A2" },
        { german: "die Stellenanzeige", polish: "ogłoszenie o pracę", example: "Ich habe die Stellenanzeige online gefunden.", level: "B1" },
        { german: "die Erfahrung", polish: "doświadczenie", example: "Ich habe fünf Jahre Erfahrung.", level: "A2" },
        { german: "die Berufserfahrung", polish: "doświadczenie zawodowe", example: "Welche Berufserfahrung bringen Sie mit?", level: "B1" },
        { german: "die Ausbildung", polish: "wykształcenie / szkolenie zawodowe", example: "Ich habe eine Ausbildung als Elektriker gemacht.", level: "A2" },
        { german: "das Zeugnis", polish: "świadectwo", example: "Hier sind meine Zeugnisse.", level: "A2" },
        { german: "die Kenntnisse", polish: "umiejętności / znajomość", example: "Ich habe gute Deutschkenntnisse.", level: "B1" },
        { german: "die Stärken und Schwächen", polish: "mocne i słabe strony", example: "Was sind Ihre Stärken und Schwächen?", level: "B1" },
        { german: "Erzählen Sie etwas über sich.", polish: "Proszę opowiedzieć coś o sobie.", example: "Erzählen Sie bitte etwas über sich.", level: "B1" },
        { german: "Warum möchten Sie bei uns arbeiten?", polish: "Dlaczego chce Pan/Pani u nas pracować?", example: "Warum möchten Sie bei uns arbeiten?", level: "B1" },
        { german: "Ich arbeite gern im Team.", polish: "Lubię pracować w zespole.", example: "Ich arbeite gern im Team, kann aber auch selbstständig arbeiten.", level: "A2" },
        { german: "Ich lerne schnell.", polish: "Szybko się uczę.", example: "Ich bin neu in dem Bereich, aber ich lerne schnell.", level: "A2" },
        { german: "Ich bin zuverlässig.", polish: "Jestem niezawodny/niezawodna.", example: "Ich bin pünktlich und zuverlässig.", level: "A2" },
        { german: "Ich bin belastbar.", polish: "Jestem odporny/odporna na stres.", example: "Ich bin flexibel und belastbar.", level: "B1" },
        { german: "das Gehalt", polish: "pensja / wynagrodzenie", example: "Wie hoch ist das Gehalt?", level: "A2" },
        { german: "der Lohn", polish: "płaca (za godzinę)", example: "Der Lohn wird pünktlich gezahlt.", level: "A2" },
        { german: "die Gehaltsvorstellung", polish: "oczekiwania finansowe", example: "Was ist Ihre Gehaltsvorstellung?", level: "B1" },
        { german: "die Arbeitszeit", polish: "czas pracy", example: "Wie sind die Arbeitszeiten?", level: "A2" },
        { german: "die Probezeit", polish: "okres próbny", example: "Die Probezeit dauert sechs Monate.", level: "B1" },
        { german: "der Arbeitsvertrag", polish: "umowa o pracę", example: "Ich habe den Arbeitsvertrag unterschrieben.", level: "B1" },
        { german: "unbefristet / befristet", polish: "na czas nieokreślony / określony", example: "Die Stelle ist unbefristet.", level: "B1" },
        { german: "Vollzeit / Teilzeit", polish: "pełny etat / niepełny etat", example: "Ich suche eine Stelle in Vollzeit.", level: "A2" },
        { german: "die Schichtarbeit", polish: "praca zmianowa", example: "Sind Sie bereit für Schichtarbeit?", level: "B1" },
        { german: "die Überstunden", polish: "nadgodziny", example: "Werden Überstunden bezahlt?", level: "B1" },
        { german: "der Urlaubsanspruch", polish: "wymiar urlopu", example: "Wie viele Urlaubstage habe ich?", level: "B1" },
        { german: "Wann kann ich anfangen?", polish: "Kiedy mogę zacząć?", example: "Die Stelle gefällt mir – wann kann ich anfangen?", level: "A2" },
        { german: "Ich kann sofort anfangen.", polish: "Mogę zacząć od zaraz.", example: "Ich bin verfügbar und kann sofort anfangen.", level: "A2" },
        { german: "die Kündigungsfrist", polish: "okres wypowiedzenia", example: "Meine Kündigungsfrist beträgt einen Monat.", level: "B1" },
        { german: "die Zusage / die Absage", polish: "przyjęcie / odmowa", example: "Ich habe eine Zusage bekommen!", level: "B1" },
        { german: "Wir melden uns bei Ihnen.", polish: "Odezwiemy się do Pana/Pani.", example: "Danke für das Gespräch, wir melden uns bei Ihnen.", level: "B1" },
    ],

    // 🗨️ ROZMOWY W PRACY (A2-B1)
    work_talk: [
        { german: "Ich bin neu hier.", polish: "Jestem tu nowy/nowa.", example: "Hallo, ich bin neu hier – ich fange heute an.", level: "A2" },
        { german: "Kannst du mir das zeigen?", polish: "Możesz mi to pokazać?", example: "Ich kenne das System nicht – kannst du mir das zeigen?", level: "A2" },
        { german: "Wie funktioniert das?", polish: "Jak to działa?", example: "Wie funktioniert diese Maschine?", level: "A2" },
        { german: "Ich habe eine Frage.", polish: "Mam pytanie.", example: "Entschuldigung, ich habe eine kurze Frage.", level: "A1" },
        { german: "Kein Problem, ich helfe dir.", polish: "Żaden problem, pomogę ci.", example: "Kein Problem, ich helfe dir dabei.", level: "A2" },
        { german: "Wer ist dafür zuständig?", polish: "Kto jest za to odpowiedzialny?", example: "Wer ist für die Bestellungen zuständig?", level: "B1" },
        { german: "Ich kümmere mich darum.", polish: "Zajmę się tym.", example: "Kein Stress, ich kümmere mich darum.", level: "B1" },
        { german: "Das erledige ich.", polish: "Ja to załatwię.", example: "Die E-Mail? Das erledige ich gleich.", level: "A2" },
        { german: "Bis wann muss das fertig sein?", polish: "Do kiedy to ma być gotowe?", example: "Bis wann muss der Auftrag fertig sein?", level: "A2" },
        { german: "Das schaffe ich bis morgen.", polish: "Zdążę z tym do jutra.", example: "Das schaffe ich locker bis morgen.", level: "A2" },
        { german: "Das schaffe ich nicht.", polish: "Nie zdążę / nie dam rady.", example: "Bis heute Abend? Das schaffe ich leider nicht.", level: "A2" },
        { german: "Ich brauche mehr Zeit.", polish: "Potrzebuję więcej czasu.", example: "Ich brauche noch einen Tag mehr Zeit.", level: "A2" },
        { german: "Ich bin gleich zurück.", polish: "Zaraz wracam.", example: "Ich bin in fünf Minuten zurück.", level: "A2" },
        { german: "Ich mache Pause.", polish: "Robię przerwę.", example: "Ich mache kurz Pause, okay?", level: "A1" },
        { german: "die Mittagspause", polish: "przerwa obiadowa", example: "Um 12 haben wir Mittagspause.", level: "A1" },
        { german: "Gehst du mit zum Mittagessen?", polish: "Idziesz ze mną na obiad?", example: "Gehst du mit zum Mittagessen in die Kantine?", level: "A2" },
        { german: "der Feierabend", polish: "koniec pracy / fajrant", example: "Endlich Feierabend!", level: "A1" },
        { german: "Ich mache Feierabend.", polish: "Kończę pracę.", example: "Es ist 17 Uhr, ich mache Feierabend.", level: "A2" },
        { german: "Schönen Feierabend!", polish: "Miłego fajrantu!", example: "Tschüss, schönen Feierabend!", level: "A1" },
        { german: "die Besprechung / das Meeting", polish: "zebranie / spotkanie", example: "Um 10 haben wir eine Besprechung.", level: "A2" },
        { german: "der Kollege / die Kollegin", polish: "kolega / koleżanka z pracy", example: "Das ist mein Kollege Marek.", level: "A1" },
        { german: "der Chef / die Chefin", polish: "szef / szefowa", example: "Der Chef ist heute nicht da.", level: "A1" },
        { german: "Ich melde mich krank.", polish: "Zgłaszam chorobę (biorę L4).", example: "Mir geht es schlecht, ich melde mich heute krank.", level: "B1" },
        { german: "Ich nehme Urlaub.", polish: "Biorę urlop.", example: "Nächste Woche nehme ich Urlaub.", level: "A2" },
        { german: "Ich habe frei.", polish: "Mam wolne.", example: "Am Freitag habe ich frei.", level: "A1" },
        { german: "die Schicht", polish: "zmiana (w pracy)", example: "Ich habe diese Woche Frühschicht.", level: "A2" },
        { german: "Frühschicht / Spätschicht / Nachtschicht", polish: "ranna / popołudniowa / nocna zmiana", example: "Nächste Woche habe ich Nachtschicht.", level: "B1" },
        { german: "einspringen", polish: "zastąpić kogoś / wskoczyć za kogoś", example: "Kannst du morgen für mich einspringen?", level: "B1" },
        { german: "Können wir tauschen?", polish: "Możemy się zamienić?", example: "Können wir die Schichten tauschen?", level: "A2" },
        { german: "Gut gemacht!", polish: "Dobra robota!", example: "Das sieht super aus – gut gemacht!", level: "A1" },
        { german: "Danke für deine Hilfe.", polish: "Dziękuję za pomoc.", example: "Danke für deine Hilfe heute!", level: "A1" },
        { german: "Das war ein langer Tag.", polish: "To był długi dzień.", example: "Puh, das war ein langer Tag.", level: "A2" },
        { german: "Ich verstehe das nicht ganz.", polish: "Nie do końca to rozumiem.", example: "Kannst du das erklären? Ich verstehe das nicht ganz.", level: "A2" },
        { german: "Kannst du das bitte wiederholen?", polish: "Możesz to powtórzyć?", example: "Langsamer bitte – kannst du das wiederholen?", level: "A1" },
        { german: "Alles erledigt.", polish: "Wszystko załatwione.", example: "Die Aufgaben von heute? Alles erledigt.", level: "A2" },
        { german: "der Auftrag", polish: "zlecenie", example: "Wir haben einen neuen Auftrag bekommen.", level: "A2" },
        { german: "die Aufgabe", polish: "zadanie", example: "Was ist meine Aufgabe für heute?", level: "A1" },
        { german: "die Baustelle / der Einsatzort", polish: "miejsce pracy / plac budowy", example: "Wo ist morgen der Einsatzort?", level: "B1" },
        { german: "das Werkzeug mitbringen", polish: "przynieść narzędzia", example: "Bring bitte dein eigenes Werkzeug mit.", level: "A2" },
        { german: "Vorsicht!", polish: "Uwaga! / Ostrożnie!", example: "Vorsicht, das ist schwer!", level: "A1" },
    ],

    // ❓ SŁÓWKA PYTAJĄCE W ZDANIACH (A1-B1)
    question_words: [
        { german: "Wo?", polish: "Gdzie?", example: "Wo wohnst du? – In Berlin.", level: "A1" },
        { german: "Wohin?", polish: "Dokąd?", example: "Wohin gehst du? – Nach Hause.", level: "A1" },
        { german: "Woher?", polish: "Skąd?", example: "Woher kommst du? – Aus Polen.", level: "A1" },
        { german: "Wann?", polish: "Kiedy?", example: "Wann kommst du? – Um acht Uhr.", level: "A1" },
        { german: "Seit wann?", polish: "Od kiedy?", example: "Seit wann lernst du Deutsch? – Seit einem Jahr.", level: "A2" },
        { german: "Bis wann?", polish: "Do kiedy?", example: "Bis wann arbeitest du? – Bis 17 Uhr.", level: "A2" },
        { german: "Wie lange?", polish: "Jak długo?", example: "Wie lange bleibst du? – Zwei Stunden.", level: "A2" },
        { german: "Wie oft?", polish: "Jak często?", example: "Wie oft machst du Sport? – Dreimal pro Woche.", level: "A2" },
        { german: "Warum?", polish: "Dlaczego?", example: "Warum lernst du Deutsch? – Wegen der Arbeit.", level: "A1" },
        { german: "Wozu?", polish: "Po co? / W jakim celu?", example: "Wozu brauchst du das? – Zum Kochen.", level: "B1" },
        { german: "Wofür?", polish: "Na co? / Po co?", example: "Wofür ist das Geld? – Für die Miete.", level: "B1" },
        { german: "Wer?", polish: "Kto?", example: "Wer ist das? – Das ist mein Bruder.", level: "A1" },
        { german: "Wen?", polish: "Kogo? (biernik)", example: "Wen besuchst du? – Meine Oma.", level: "A2" },
        { german: "Wem?", polish: "Komu? (celownik)", example: "Wem hilfst du? – Meinem Freund.", level: "A2" },
        { german: "Wessen?", polish: "Czyj? (dopełniacz)", example: "Wessen Auto ist das? – Das ist Toms Auto.", level: "B1" },
        { german: "Was?", polish: "Co?", example: "Was machst du? – Ich lese ein Buch.", level: "A1" },
        { german: "Was für ein...?", polish: "Jaki? / Co za...?", example: "Was für ein Auto hast du? – Ein rotes.", level: "A2" },
        { german: "Welcher / Welche / Welches?", polish: "Który / Która / Które?", example: "Welche Farbe magst du? – Blau.", level: "A2" },
        { german: "Wie?", polish: "Jak?", example: "Wie geht es dir? – Danke, gut.", level: "A1" },
        { german: "Wie viel?", polish: "Ile? (niepoliczalne)", example: "Wie viel kostet das? – Zehn Euro.", level: "A1" },
        { german: "Wie viele?", polish: "Ile? (policzalne)", example: "Wie viele Kinder hast du? – Zwei.", level: "A1" },
        { german: "Mit wem?", polish: "Z kim?", example: "Mit wem gehst du? – Mit meiner Schwester.", level: "A2" },
        { german: "Für wen?", polish: "Dla kogo?", example: "Für wen ist das Geschenk? – Für dich.", level: "A2" },
        { german: "Worüber?", polish: "O czym?", example: "Worüber sprecht ihr? – Über die Arbeit.", level: "B1" },
        { german: "Worauf?", polish: "Na co? (czekać itp.)", example: "Worauf wartest du? – Auf den Bus.", level: "B1" },
        { german: "Womit?", polish: "Czym? / Za pomocą czego?", example: "Womit fährst du? – Mit dem Zug.", level: "A2" },
        { german: "Wovon?", polish: "O czym / Z czego?", example: "Wovon träumst du? – Von einem Urlaub.", level: "B1" },
    ],

    // 📍 PRZYIMKI MIEJSCA W ZDANIACH (A1-B1)
    local_prepositions: [
        { german: "in", polish: "w / w środku", example: "Das Buch ist in der Tasche.", level: "A1" },
        { german: "auf", polish: "na (powierzchni)", example: "Das Glas steht auf dem Tisch.", level: "A1" },
        { german: "unter", polish: "pod", example: "Die Katze liegt unter dem Bett.", level: "A1" },
        { german: "über", polish: "nad", example: "Die Lampe hängt über dem Tisch.", level: "A1" },
        { german: "vor", polish: "przed", example: "Das Auto steht vor dem Haus.", level: "A1" },
        { german: "hinter", polish: "za", example: "Der Garten ist hinter dem Haus.", level: "A1" },
        { german: "neben", polish: "obok", example: "Die Bank ist neben der Post.", level: "A1" },
        { german: "zwischen", polish: "między / pomiędzy", example: "Die Apotheke ist zwischen dem Café und der Bank.", level: "A2" },
        { german: "an", polish: "przy / na (pionowej)", example: "Das Bild hängt an der Wand.", level: "A1" },
        { german: "bei", polish: "u / przy (kogoś)", example: "Ich bin bei meiner Oma.", level: "A1" },
        { german: "gegenüber", polish: "naprzeciwko", example: "Die Schule ist gegenüber dem Park.", level: "A2" },
        { german: "neben ... und ...", polish: "obok ... i ...", example: "Ich sitze neben Anna und Tom.", level: "A2" },
        { german: "aus", polish: "z / ze (wnętrza)", example: "Er kommt aus dem Haus.", level: "A1" },
        { german: "von", polish: "od / z", example: "Ich komme gerade von der Arbeit.", level: "A1" },
        { german: "zu", polish: "do (osoby / miejsca)", example: "Ich gehe zu meinem Freund.", level: "A1" },
        { german: "nach", polish: "do (miasta / kraju)", example: "Wir fahren nach Deutschland.", level: "A1" },
        { german: "durch", polish: "przez (na wskroś)", example: "Wir gehen durch den Park.", level: "A2" },
        { german: "um", polish: "wokół / dookoła", example: "Wir laufen um den See.", level: "A2" },
        { german: "entlang", polish: "wzdłuż", example: "Wir gehen die Straße entlang.", level: "B1" },
        { german: "innerhalb", polish: "wewnątrz / w obrębie", example: "Innerhalb der Stadt gibt es viele Cafés.", level: "B1" },
        { german: "außerhalb", polish: "poza / na zewnątrz", example: "Sie wohnt außerhalb der Stadt.", level: "B1" },
        { german: "oben", polish: "na górze / u góry", example: "Das Schlafzimmer ist oben.", level: "A2" },
        { german: "unten", polish: "na dole / u dołu", example: "Die Küche ist unten.", level: "A2" },
        { german: "links", polish: "na lewo / po lewej", example: "Die Toilette ist links.", level: "A1" },
        { german: "rechts", polish: "na prawo / po prawej", example: "Die Bank ist rechts.", level: "A1" },
        { german: "geradeaus", polish: "prosto", example: "Gehen Sie geradeaus, dann links.", level: "A1" },
        { german: "in der Nähe von", polish: "w pobliżu / blisko", example: "Ich wohne in der Nähe vom Bahnhof.", level: "A2" },
        { german: "weit weg von", polish: "daleko od", example: "Das Hotel ist weit weg vom Zentrum.", level: "A2" },
    ],

    // 🛒 PRODUKTY SPOŻYWCZE (A1-A2)
    groceries: [
        { german: "das Brot", polish: "chleb", example: "Ich kaufe ein frisches Brot.", level: "A1" },
        { german: "die Brötchen", polish: "bułki", example: "Zum Frühstück esse ich Brötchen.", level: "A1" },
        { german: "die Butter", polish: "masło", example: "Die Butter ist im Kühlschrank.", level: "A1" },
        { german: "der Käse", polish: "ser", example: "Ich hätte gern 200 Gramm Käse.", level: "A1" },
        { german: "die Wurst", polish: "kiełbasa / wędlina", example: "Welche Wurst möchten Sie?", level: "A1" },
        { german: "die Milch", polish: "mleko", example: "Wir brauchen noch Milch.", level: "A1" },
        { german: "die Eier", polish: "jajka", example: "Ein Dutzend Eier, bitte.", level: "A1" },
        { german: "der Zucker", polish: "cukier", example: "Nimmst du Zucker in den Kaffee?", level: "A1" },
        { german: "das Salz", polish: "sól", example: "Das Salz ist alle.", level: "A1" },
        { german: "das Mehl", polish: "mąka", example: "Für den Kuchen brauche ich Mehl.", level: "A2" },
        { german: "das Öl", polish: "olej", example: "Gib etwas Öl in die Pfanne.", level: "A2" },
        { german: "der Apfel", polish: "jabłko", example: "Ein Apfel am Tag ist gesund.", level: "A1" },
        { german: "die Banane", polish: "banan", example: "Die Bananen sind noch grün.", level: "A1" },
        { german: "die Kartoffel", polish: "ziemniak", example: "Wir essen Kartoffeln zum Mittag.", level: "A1" },
        { german: "die Tomate", polish: "pomidor", example: "Die Tomaten sind reif.", level: "A1" },
        { german: "die Zwiebel", polish: "cebula", example: "Schneide bitte die Zwiebel.", level: "A2" },
        { german: "das Gemüse", polish: "warzywa", example: "Iss mehr Gemüse!", level: "A1" },
        { german: "das Obst", polish: "owoce", example: "Frisches Obst ist gesund.", level: "A1" },
        { german: "das Fleisch", polish: "mięso", example: "Ich esse wenig Fleisch.", level: "A1" },
        { german: "der Fisch", polish: "ryba", example: "Freitags gibt es oft Fisch.", level: "A1" },
        { german: "der Reis", polish: "ryż", example: "Kochst du Reis oder Nudeln?", level: "A1" },
        { german: "die Nudeln", polish: "makaron", example: "Die Kinder lieben Nudeln.", level: "A1" },
        { german: "das Wasser", polish: "woda", example: "Eine Flasche Wasser, bitte.", level: "A1" },
        { german: "der Saft", polish: "sok", example: "Ich trinke gern Orangensaft.", level: "A1" },
        { german: "die Tüte", polish: "torba / reklamówka", example: "Brauchen Sie eine Tüte?", level: "A2" },
    ],

    // 🚗 SAMOCHÓD I JAZDA (A2-B1)
    car_driving: [
        { german: "das Auto", polish: "samochód", example: "Mein Auto springt nicht an.", level: "A1" },
        { german: "fahren", polish: "jechać / prowadzić", example: "Ich fahre vorsichtig.", level: "A1" },
        { german: "der Führerschein", polish: "prawo jazdy", example: "Hast du den Führerschein dabei?", level: "A2" },
        { german: "tanken", polish: "tankować", example: "Ich muss noch tanken.", level: "A2" },
        { german: "die Tankstelle", polish: "stacja benzynowa", example: "Wo ist die nächste Tankstelle?", level: "A2" },
        { german: "das Benzin", polish: "benzyna", example: "Das Benzin ist teuer geworden.", level: "A2" },
        { german: "der Diesel", polish: "olej napędowy / diesel", example: "Mein Auto fährt mit Diesel.", level: "A2" },
        { german: "der Reifen", polish: "opona", example: "Der Reifen ist platt.", level: "A2" },
        { german: "die Bremse", polish: "hamulec", example: "Die Bremsen funktionieren gut.", level: "B1" },
        { german: "bremsen", polish: "hamować", example: "Brems, die Ampel ist rot!", level: "A2" },
        { german: "der Stau", polish: "korek", example: "Wir stehen im Stau.", level: "A2" },
        { german: "die Autobahn", polish: "autostrada", example: "Auf der Autobahn darf man schnell fahren.", level: "A2" },
        { german: "die Ampel", polish: "sygnalizacja świetlna", example: "An der Ampel rechts abbiegen.", level: "A2" },
        { german: "abbiegen", polish: "skręcać", example: "Bieg an der Kreuzung links ab.", level: "A2" },
        { german: "parken", polish: "parkować", example: "Hier darf man nicht parken.", level: "A2" },
        { german: "der Parkplatz", polish: "parking / miejsce parkingowe", example: "Ich suche einen Parkplatz.", level: "A2" },
        { german: "die Werkstatt", polish: "warsztat", example: "Das Auto muss in die Werkstatt.", level: "B1" },
        { german: "die Panne", polish: "awaria", example: "Wir hatten eine Panne auf der Autobahn.", level: "B1" },
        { german: "der Unfall", polish: "wypadek", example: "Es gab einen Unfall auf der Kreuzung.", level: "A2" },
        { german: "anschnallen", polish: "zapinać pasy", example: "Bitte anschnallen!", level: "A2" },
        { german: "die Geschwindigkeit", polish: "prędkość", example: "Halte dich an die Geschwindigkeit.", level: "B1" },
        { german: "die Strafe / das Bußgeld", polish: "mandat / kara", example: "Zu schnell? Das gibt ein Bußgeld.", level: "B1" },
    ],

    // 📅 DATY I LICZBY PORZĄDKOWE (A1-A2)
    dates_ordinals: [
        { german: "der erste", polish: "pierwszy", example: "Heute ist der erste Mai.", level: "A1" },
        { german: "der zweite", polish: "drugi", example: "Am zweiten Tag war es besser.", level: "A1" },
        { german: "der dritte", polish: "trzeci", example: "Der dritte Versuch klappte.", level: "A1" },
        { german: "der vierte", polish: "czwarty", example: "Sie wohnt im vierten Stock.", level: "A1" },
        { german: "der fünfte", polish: "piąty", example: "Am fünften habe ich Geburtstag.", level: "A1" },
        { german: "der zehnte", polish: "dziesiąty", example: "Der Zug fährt am zehnten ab.", level: "A2" },
        { german: "der zwanzigste", polish: "dwudziesty", example: "Der zwanzigste ist ein Freitag.", level: "A2" },
        { german: "der einunddreißigste", polish: "trzydziesty pierwszy", example: "Der einunddreißigste Dezember ist Silvester.", level: "A2" },
        { german: "Welcher Tag ist heute?", polish: "Jaki dziś dzień?", example: "Welcher Tag ist heute? – Montag.", level: "A1" },
        { german: "Den wievielten haben wir?", polish: "Którego dziś mamy?", example: "Den wievielten haben wir heute? – Den 5.", level: "A2" },
        { german: "am Montag", polish: "w poniedziałek", example: "Am Montag habe ich einen Termin.", level: "A1" },
        { german: "im Januar", polish: "w styczniu", example: "Im Januar ist es kalt.", level: "A1" },
        { german: "im Sommer", polish: "latem", example: "Im Sommer fahren wir ans Meer.", level: "A1" },
        { german: "im Jahr 2025", polish: "w roku 2025", example: "Im Jahr 2025 ziehe ich um.", level: "A2" },
        { german: "das Datum", polish: "data", example: "Welches Datum ist heute?", level: "A2" },
        { german: "der Geburtstag", polish: "urodziny", example: "Wann hast du Geburtstag?", level: "A1" },
        { german: "der Feiertag", polish: "święto / dzień wolny", example: "Morgen ist Feiertag.", level: "A2" },
        { german: "gestern / heute / morgen", polish: "wczoraj / dziś / jutro", example: "Gestern, heute und morgen lerne ich.", level: "A1" },
        { german: "vorgestern / übermorgen", polish: "przedwczoraj / pojutrze", example: "Übermorgen habe ich frei.", level: "A2" },
        { german: "letztes / nächstes Jahr", polish: "zeszły / przyszły rok", example: "Nächstes Jahr fahre ich nach Spanien.", level: "A2" },
    ],

    // 🧹 SPRZĄTANIE – CZYNNOŚCI (A1-B1)
    cleaning: [
        { german: "putzen", polish: "sprzątać / czyścić", example: "Ich putze jeden Samstag die Wohnung.", level: "A1" },
        { german: "sauber machen", polish: "posprzątać / doprowadzić do czystości", example: "Kannst du das Bad sauber machen?", level: "A1" },
        { german: "aufräumen", polish: "porządkować / układać", example: "Räum bitte dein Zimmer auf!", level: "A1" },
        { german: "reinigen", polish: "czyścić (fachowo)", example: "Die Fenster werden zweimal im Jahr gereinigt.", level: "A2" },
        { german: "wischen", polish: "myć / wycierać (mopem)", example: "Ich wische den Boden in der Küche.", level: "A2" },
        { german: "feucht wischen", polish: "myć na wilgotno", example: "Das Laminat nur feucht wischen, nicht nass!", level: "B1" },
        { german: "fegen / kehren", polish: "zamiatać", example: "Fegst du bitte die Treppe?", level: "A2" },
        { german: "staubsaugen", polish: "odkurzać", example: "Ich staubsauge den Teppich im Wohnzimmer.", level: "A2" },
        { german: "Staub wischen", polish: "ścierać kurz", example: "Vergiss nicht, Staub zu wischen.", level: "A2" },
        { german: "abstauben", polish: "odkurzać (meble, półki)", example: "Ich staube die Regale ab.", level: "B1" },
        { german: "abwischen", polish: "przecierać / wycierać", example: "Wisch bitte den Tisch ab.", level: "A2" },
        { german: "schrubben", polish: "szorować", example: "Die Fliesen muss man richtig schrubben.", level: "B1" },
        { german: "polieren", polish: "polerować", example: "Zum Schluss die Armaturen polieren.", level: "B1" },
        { german: "spülen", polish: "zmywać / płukać", example: "Ich spüle das Geschirr von Hand.", level: "A2" },
        { german: "abwaschen", polish: "zmywać (naczynia)", example: "Wer wäscht heute ab?", level: "A2" },
        { german: "abtrocknen", polish: "wycierać do sucha", example: "Trockne die Gläser bitte gut ab.", level: "A2" },
        { german: "die Wäsche waschen", polish: "prać", example: "Ich wasche die Wäsche bei 40 Grad.", level: "A2" },
        { german: "bügeln", polish: "prasować", example: "Ich bügle die Hemden am Sonntag.", level: "A2" },
        { german: "die Wäsche aufhängen", polish: "wieszać pranie", example: "Häng bitte die Wäsche auf.", level: "A2" },
        { german: "zusammenlegen", polish: "składać (ubrania)", example: "Die Handtücher ordentlich zusammenlegen.", level: "B1" },
        { german: "den Müll rausbringen", polish: "wynosić śmieci", example: "Bring bitte den Müll raus.", level: "A2" },
        { german: "den Müll trennen", polish: "segregować śmieci", example: "In Deutschland muss man den Müll trennen.", level: "B1" },
        { german: "ausleeren", polish: "opróżniać", example: "Bitte alle Papierkörbe ausleeren.", level: "B1" },
        { german: "entsorgen", polish: "usuwać / utylizować", example: "Den Karton bitte richtig entsorgen.", level: "B1" },
        { german: "desinfizieren", polish: "dezynfekować", example: "Die Türklinken werden täglich desinfiziert.", level: "B1" },
        { german: "lüften", polish: "wietrzyć", example: "Nach dem Putzen gut lüften!", level: "A2" },
        { german: "das Bett machen", polish: "słać łóżko", example: "Mach bitte dein Bett.", level: "A1" },
        { german: "die Bettwäsche wechseln", polish: "zmieniać pościel", example: "Einmal pro Woche die Bettwäsche wechseln.", level: "B1" },
        { german: "die Handtücher wechseln", polish: "wymieniać ręczniki", example: "In den Zimmern die Handtücher wechseln.", level: "B1" },
        { german: "auffüllen / nachfüllen", polish: "uzupełniać / dopełniać", example: "Seife und Papier bitte auffüllen.", level: "B1" },
        { german: "einweichen", polish: "namaczać", example: "Die Pfanne muss erst einweichen.", level: "B1" },
        { german: "ausspülen", polish: "wypłukać", example: "Spül den Lappen gut aus.", level: "B1" },
        { german: "Flecken entfernen", polish: "usuwać plamy", example: "Kannst du diesen Fleck entfernen?", level: "B1" },
        { german: "entkalken", polish: "odkamieniać", example: "Die Kaffeemaschine muss entkalkt werden.", level: "B1" },
        { german: "trocknen lassen", polish: "zostawić do wyschnięcia", example: "Den Boden gut trocknen lassen.", level: "A2" },
        { german: "ordentlich / gründlich", polish: "porządnie / dokładnie", example: "Bitte alles gründlich putzen.", level: "A2" },
    ],

    // 🧽 SPRZĄTANIE – SPRZĘT (A1-B1)
    cleaning_equipment: [
        { german: "der Besen", polish: "miotła", example: "Der Besen steht in der Ecke.", level: "A2" },
        { german: "die Kehrschaufel", polish: "szufelka", example: "Nimm Besen und Kehrschaufel.", level: "B1" },
        { german: "der Mopp / der Wischmopp", polish: "mop", example: "Der Mopp ist schon ganz nass.", level: "A2" },
        { german: "der Putzeimer", polish: "wiadro do sprzątania", example: "Füll den Putzeimer mit warmem Wasser.", level: "A2" },
        { german: "der Staubsauger", polish: "odkurzacz", example: "Der Staubsauger ist kaputt.", level: "A2" },
        { german: "der Lappen", polish: "ścierka / szmatka", example: "Wo sind die sauberen Lappen?", level: "A2" },
        { german: "das Mikrofasertuch", polish: "ściereczka z mikrofibry", example: "Für Glas nimm ein Mikrofasertuch.", level: "B1" },
        { german: "der Schwamm", polish: "gąbka", example: "Der Schwamm ist alt, nimm einen neuen.", level: "A2" },
        { german: "die Bürste", polish: "szczotka", example: "Mit der Bürste geht es besser.", level: "A2" },
        { german: "die Klobürste / die WC-Bürste", polish: "szczotka do WC", example: "Die Klobürste steht neben der Toilette.", level: "B1" },
        { german: "die Gummihandschuhe", polish: "rękawice gumowe", example: "Zieh die Gummihandschuhe an.", level: "A2" },
        { german: "der Müllsack / der Müllbeutel", polish: "worek na śmieci", example: "Der Müllsack ist voll.", level: "A2" },
        { german: "der Mülleimer", polish: "kosz na śmieci", example: "Der Mülleimer steht unter der Spüle.", level: "A1" },
        { german: "die Mülltonne", polish: "pojemnik na śmieci (duży)", example: "Die Mülltonne wird montags geleert.", level: "B1" },
        { german: "der Papierkorb", polish: "kosz na papier", example: "Bitte alle Papierkörbe leeren.", level: "A2" },
        { german: "der Fensterabzieher", polish: "ściągaczka do szyb", example: "Mit dem Abzieher gibt es keine Streifen.", level: "B1" },
        { german: "der Wischwagen", polish: "wózek do sprzątania", example: "Der Wischwagen steht im Putzraum.", level: "B1" },
        { german: "die Waschmaschine", polish: "pralka", example: "Die Waschmaschine ist fertig.", level: "A1" },
        { german: "der Trockner", polish: "suszarka do prania", example: "Kommt das in den Trockner?", level: "A2" },
        { german: "die Spülmaschine", polish: "zmywarka", example: "Räum bitte die Spülmaschine aus.", level: "A2" },
        { german: "das Bügeleisen", polish: "żelazko", example: "Das Bügeleisen ist noch heiß.", level: "A2" },
        { german: "der Putzraum", polish: "pomieszczenie gospodarcze", example: "Die Sachen sind im Putzraum.", level: "B1" },
    ],

    // 🧴 ŚRODKI CZYSTOŚCI (A2-B1)
    cleaning_products: [
        { german: "das Putzmittel", polish: "środek czyszczący", example: "Wo stehen die Putzmittel?", level: "A2" },
        { german: "das Reinigungsmittel", polish: "środek czystości (fachowo)", example: "Bitte nur dieses Reinigungsmittel benutzen.", level: "B1" },
        { german: "der Allzweckreiniger", polish: "środek uniwersalny", example: "Der Allzweckreiniger passt für fast alles.", level: "B1" },
        { german: "das Spülmittel", polish: "płyn do naczyń", example: "Das Spülmittel ist leer.", level: "A2" },
        { german: "das Waschmittel", polish: "proszek / płyn do prania", example: "Wie viel Waschmittel nimmst du?", level: "A2" },
        { german: "der Weichspüler", polish: "płyn zmiękczający", example: "Ich benutze keinen Weichspüler.", level: "B1" },
        { german: "der Glasreiniger", polish: "płyn do szyb", example: "Nimm den Glasreiniger für die Fenster.", level: "B1" },
        { german: "der Badreiniger", polish: "środek do łazienki", example: "Der Badreiniger löst den Kalk.", level: "B1" },
        { german: "der WC-Reiniger", polish: "środek do WC", example: "WC-Reiniger unter den Rand geben.", level: "B1" },
        { german: "der Bodenreiniger", polish: "płyn do podłóg", example: "Ein Schuss Bodenreiniger reicht.", level: "B1" },
        { german: "das Desinfektionsmittel", polish: "środek dezynfekujący", example: "Desinfektionsmittel steht am Eingang.", level: "B1" },
        { german: "der Entkalker", polish: "odkamieniacz", example: "Der Entkalker hilft gegen Kalk.", level: "B1" },
        { german: "der Fleckenentferner", polish: "odplamiacz", example: "Probier mal den Fleckenentferner.", level: "B1" },
        { german: "die Seife / die Handseife", polish: "mydło / mydło do rąk", example: "Die Handseife ist alle.", level: "A1" },
        { german: "der Essig", polish: "ocet", example: "Essig ist ein gutes Hausmittel gegen Kalk.", level: "A2" },
        { german: "das Toilettenpapier", polish: "papier toaletowy", example: "Bitte Toilettenpapier nachfüllen.", level: "A1" },
        { german: "das Papiertuch", polish: "ręcznik papierowy", example: "Nimm ein Papiertuch zum Abtrocknen.", level: "A2" },
        { german: "der Kalk", polish: "kamień (osad)", example: "Im Bad ist überall Kalk.", level: "B1" },
        { german: "der Schmutz / der Dreck", polish: "brud (potocznie: Dreck)", example: "Der Schmutz geht nicht ab.", level: "A2" },
        { german: "der Staub", polish: "kurz", example: "Überall liegt Staub.", level: "A2" },
    ],

    // 🧼 PRACA W SPRZĄTANIU (A2-B1)
    cleaning_work: [
        { german: "die Reinigungskraft", polish: "osoba sprzątająca (zawód)", example: "Wir suchen eine Reinigungskraft.", level: "B1" },
        { german: "die Putzfrau / der Putzmann", polish: "sprzątaczka / sprzątacz", example: "Die Putzfrau kommt dienstags.", level: "A2" },
        { german: "die Reinigungsfirma", polish: "firma sprzątająca", example: "Ich arbeite für eine Reinigungsfirma.", level: "B1" },
        { german: "die Gebäudereinigung", polish: "sprzątanie budynków", example: "Er arbeitet in der Gebäudereinigung.", level: "B1" },
        { german: "die Unterhaltsreinigung", polish: "sprzątanie bieżące", example: "Das ist normale Unterhaltsreinigung.", level: "B1" },
        { german: "die Grundreinigung", polish: "sprzątanie gruntowne", example: "Einmal im Jahr machen wir eine Grundreinigung.", level: "B1" },
        { german: "die Treppenhausreinigung", polish: "sprzątanie klatki schodowej", example: "Die Treppenhausreinigung ist freitags.", level: "B1" },
        { german: "die Fensterreinigung", polish: "mycie okien", example: "Die Fensterreinigung kostet extra.", level: "B1" },
        { german: "der Putzplan", polish: "plan sprzątania", example: "Schau bitte auf den Putzplan.", level: "B1" },
        { german: "Wo sind die Putzsachen?", polish: "Gdzie są rzeczy do sprzątania?", example: "Entschuldigung, wo sind die Putzsachen?", level: "A2" },
        { german: "Womit soll ich anfangen?", polish: "Od czego mam zacząć?", example: "Womit soll ich heute anfangen?", level: "A2" },
        { german: "Wie oft soll ich das machen?", polish: "Jak często mam to robić?", example: "Wie oft soll ich die Fenster putzen?", level: "A2" },
        { german: "einmal pro Woche", polish: "raz w tygodniu", example: "Das machen wir einmal pro Woche.", level: "A2" },
        { german: "Ich bin fertig mit dem Bad.", polish: "Skończyłem/am łazienkę.", example: "Ich bin fertig mit dem Bad, was noch?", level: "A2" },
        { german: "Das muss noch gemacht werden.", polish: "To trzeba jeszcze zrobić.", example: "Die Küche muss noch gemacht werden.", level: "B1" },
        { german: "Hier ist ein Fleck.", polish: "Tu jest plama.", example: "Hier ist ein Fleck auf dem Teppich.", level: "A2" },
        { german: "Das geht nicht ab.", polish: "To nie schodzi.", example: "Ich hab's probiert – das geht nicht ab.", level: "B1" },
        { german: "Der Boden ist noch nass.", polish: "Podłoga jest jeszcze mokra.", example: "Vorsicht, der Boden ist noch nass!", level: "A2" },
        { german: "Vorsicht, rutschig!", polish: "Uwaga, ślisko!", example: "Vorsicht, rutschig – bitte langsam gehen!", level: "A2" },
        { german: "Bitte nicht betreten.", polish: "Proszę nie wchodzić.", example: "Frisch gewischt – bitte nicht betreten.", level: "B1" },
        { german: "Ich brauche mehr Lappen.", polish: "Potrzebuję więcej ścierek.", example: "Ich brauche mehr Lappen und Handschuhe.", level: "A2" },
        { german: "Das Mittel ist alle.", polish: "Środek się skończył.", example: "Der Glasreiniger ist alle.", level: "B1" },
        { german: "Die Toilette ist verstopft.", polish: "Toaleta jest zatkana.", example: "Die Toilette im ersten Stock ist verstopft.", level: "B1" },
        { german: "Der Staubsauger geht nicht.", polish: "Odkurzacz nie działa.", example: "Der Staubsauger geht nicht mehr.", level: "A2" },
        { german: "Ist alles sauber?", polish: "Czy wszystko czyste?", example: "Schau bitte nach – ist alles sauber?", level: "A2" },
        { german: "Es sieht super aus!", polish: "Wygląda świetnie!", example: "Danke, es sieht super aus!", level: "A2" },
        { german: "Es riecht frisch.", polish: "Ładnie / świeżo pachnie.", example: "Nach dem Putzen riecht es frisch.", level: "A2" },
        { german: "die Arbeitskleidung", polish: "odzież robocza", example: "Bitte immer Arbeitskleidung tragen.", level: "B1" },
        { german: "die Schlüssel abgeben", polish: "oddać klucze", example: "Nach der Schicht die Schlüssel abgeben.", level: "B1" },
        { german: "Kann ich Feierabend machen?", polish: "Czy mogę kończyć pracę?", example: "Alles fertig – kann ich Feierabend machen?", level: "A2" },
    ],
